...
# Launch the 'compute' function on the device to perform halo exchanges
runner.launch('compute', nonblock=False)

# # Loop through each Processing Element (PE) in the grid to retrieve and compare data
for pe_x in range(PE_GRID_X_DIM):
    for pe_y in range(PE_GRID_Y_DIM):
        ...
        # Refer to the Cerebras SDK documentation for details on memcpy parameters and usage. Here we copy data from device to host.
...
runner.stop()
print("Succesfully completed code execution. This does not imply correctness of results.", file=outfile)
